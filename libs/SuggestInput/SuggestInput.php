 ...
 */
class SuggestInput extends TextInput
{
    ...
    */
     ...
     * @return SuggestInput
     */
    public static function addSuggestInput(\Nette\Application\UI\Form $form, $name, $label, $suggestLink = NULL, ISuggester $suggester = NULL, $cols = NULL, $maxLength = NULL)
    {
